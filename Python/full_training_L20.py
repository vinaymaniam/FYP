...
from cent_to_heir_NF import cent_to_heirL20
...
def runFullTraining(rkm=1,rmc=1,rcm2c=1):
    ...
    if(stage==1):
        dx = 'DX_and_DY/DX_all_L20.mat'
        dy = 'DX_and_DY/DY_all_L20.mat'
    else:
        dx = 'DX_and_DY/DX_all_L20_'+str(stage)+'.mat'
        dy = 'DX_and_DY/DY_all_L20_'+str(stage)+'.mat'
    ...
    for n in ns :
        ...
        if(rcm2c==1):
            ...
            success = eng.ConvMat2CellL20(n, stage)
