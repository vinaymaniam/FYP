...
%% ############  CHECK ME  ####################
if stage == 1
    savefilename_X = sprintf('../Python/DX_and_DY/DX_all_L20.mat');
    savefilename_Y = sprintf('../Python/DX_and_DY/DY_all_L20.mat');
    directory_x = 'TrainingData/L20_0'; %Stage 1
else
    savefilename_X = sprintf('../Python/DX_and_DY/DX_all_L20_%i.mat',stage);
    savefilename_Y = sprintf('../Python/DX_and_DY/DY_all_L20_%i.mat',stage);
    directory_x = sprintf('TrainingData/L20_%i',stage-1); %Stage 2+
end
