...
savefilename_X = sprintf('../Python_alt/DX_and_DY/DX_all01.mat');
savefilename_Y = sprintf('../Python_alt/DX_and_DY/DY_all01.mat');
directory_x = 'TrainingData/Alt0';
pattern = '*.bmp';
directory_y = 'TrainingData/Alt1'; 
