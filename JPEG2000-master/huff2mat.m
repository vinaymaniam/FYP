...
% codegen -config:lib unravel_m -args {0, 0.0, 0.0, 0.0, 0};
% coder.ceval('unravel_m_initialize');
% x = coder.ceval('unravel_m',y.code', link, m * n);    % Decode using C 'unravel'
% coder.ceval('unravel_m_terminate');
